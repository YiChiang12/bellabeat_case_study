...
# analysis.R
# Analyzes Fitbit data to identify user trends for Bellabeat case study
...
# Load data
daily_activity <- read_csv("data/processed-data/daily_activity_clean.csv")
daily_sleep <- read_csv("data/processed-data/daily_sleep_clean.csv")
merged <- read_csv("data/processed-data/merged_activity_sleep.csv")
hourly_steps <- read_csv("data/processed-data/hourly_steps_clean.csv")
